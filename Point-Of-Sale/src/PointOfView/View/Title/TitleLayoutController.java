...
public class TitleLayoutController implements Initializable {
	...
	@FXML
	private Button btnStaffMenu;
	@FXML
	private Button btnStatisticsMenu;
	@FXML
	...
	public void showOrderMenu() {
		try {
			...
			FXMLLoader loader = new FXMLLoader(
					TitleLayoutController.class.getResource("/PointOfView/View/Table/TableLayout.fxml"));
	...
	public void showStockManagementMenu() {
		try {
			...
			FXMLLoader loader = new FXMLLoader(
					TitleLayoutController.class.getResource("/PointOfView/View/Stock/StockLayout.fxml"));
			BorderPane pane = loader.load();
	...
	public void showConfigurationMenu() {
		try {
			...
			FXMLLoader loader = new FXMLLoader(
					TitleLayoutController.class.getResource("/PointOfView/View/Config/ConfigLayout.fxml"));
			BorderPane pane = loader.load();
	...
	public void showStaffManagementMenu() {
		...
		new ExceptionDialog(AlertType.INFORMATION, "제공되지 않음", "불필요한 기능 제거", "현재 버전에서 제공되지 않는 기능입니다.").showAndWait();
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader(
					TitleLayoutController.class.getResource("/PointOfView/View/Staff/StaffManagementLayout.fxml"));
			BorderPane pane = loader.load();
